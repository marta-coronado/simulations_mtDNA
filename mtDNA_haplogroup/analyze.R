...
setwd("/run/user/1001/gvfs/sftp:host=158.109.38.201,user=mcoronado/data/home/mcoronado/Simulations_mtDNA_Pipeline/mtDNA_haplogroup/Simulations/")
...
ggsave("PhiPack_haplogroups_3scenarios.png",width = 7.50, height = 5)
